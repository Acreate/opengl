...
public:
	...
	/// @brief 配置 shader 当中的矩阵变量
	/// @param matrix_value_for_shader_name 矩阵变量名称
	/// @param mat_value 矩阵值
	void setMatrix( const std::string &matrix_value_for_shader_name, const glm::mat4 &mat_value ) const;
