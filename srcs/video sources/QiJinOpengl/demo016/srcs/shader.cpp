...
void Shader::setMatrix( const std::string &matrix_value_for_shader_name, const glm::mat4 &mat_value ) const {
	glUniformMatrix4fv( glGetUniformLocation( m_shaderProgram, matrix_value_for_shader_name.c_str( ) ), 1, GL_FALSE, glm::value_ptr( mat_value ) );
}
